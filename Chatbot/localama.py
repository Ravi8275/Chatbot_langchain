...
#langchain community for third party integrations for example ollama here
...
st.title("Try out LLM model with Langchain and llama2")
input_text=st.text_input("write down your query")

#Ollama llama2 LLM
LLM=Ollama(model="llama2") #model declaration
